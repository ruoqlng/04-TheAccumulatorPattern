...
def run_test_count_cosines_from():
    ...
    # Test 2:
    expected = 3
    answer = count_cosines_from(3, 7, 0.11)
    print('Test 2 expected:', expected)
    print('       actual:  ', answer)

    # Test 3:
    expected = 1
    answer = count_cosines_from(6, 9, 0.88)
    print('Test 3 expected:', expected)
    print('       actual:  ', answer)

    # Test 4:
    expected = 1
    answer = count_cosines_from(7, 7, 0.05)
    print('Test 4 expected:', expected)
    print('       actual:  ', answer)

    # Test 5:
    expected = 1
    answer = count_cosines_from(4, 6, 0.74)
    print('Test 5 expected:', expected)
    print('       actual:  ', answer)

    # Test 6:
    expected = 1
    answer = count_cosines_from(3, 4, -0.66)
...
def run_test_sum_unit_fractions_from():
    ...
    # Test 3:
    expected = 0.81988
    answer = sum_unit_fractions_from(6, 12)
    print('Test 3 expected:', expected, '(approximately)')
    print('       actual:  ', answer)

    # Test 4:
    expected = 2.308
    answer = sum_unit_fractions_from(100, 1000)
